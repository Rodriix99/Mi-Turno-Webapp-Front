      ...
      <div className="w-full max-w-sm max-h-72 p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
        <div className="">
          ...
          <div className="p-3 text-center space-x-4 md:block">
            <button
              className="flex items-center justify-center w-full px-6 py-3 text-base font-roboto text-center text-white transition duration-500 ease-in-out transform bg-purple-600 rounded-xl hover:bg-purple-500 focus:ring-0 mb-1 "
              onClick={() => setIsOpenErr(false)}
            >
              Volver a intentar
            </button>
          </div>
