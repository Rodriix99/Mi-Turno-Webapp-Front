...
function CreateBranch(): JSX.Element {
  ...
  return (
    ...
    >
      <div className="w-cb h-cb max-[768px]:w-cbmd max-[768px]:h-cbmd shadow-rl bg-white rounded-lg p-7">
        ...
        <div className="flex justify-between mt-4 max-[768px]:flex-col">
          ...
          <div className="flex flex-col justify-center max-[640px]:mt-4">
            ...
            <div className="flex flex-col items-center justify-center">
              <select className="border-gray-300 md:w-96 max-[768px]:w-full p-2 rounded-lg focus:border-purple-500 border-2 focus:ring-0 ">
