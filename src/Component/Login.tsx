  ...
  return (
    <section className="">
      <div className="shadow-xl flex flex-col justify-center items-center w-full max-w-md p-5 mx-auto mt-24 rounded-lg text-lg">
        <h1 className="font-roboto ">Iniciar sesión</h1>
        <form action="#" method="POST" className="space-y-6 w-full">
          <div className="">
            <label
              htmlFor="email"
              className="block text-sm text-neutral-600 font-roboto"
            >
              Usuario
            </label>
            <div className="mt-1">
          ...
          <div className="flex items-center justify-center">
            <div className="text-sm ">
              <a
                href="#"
                className="font-roboto text-violet-600 hover:text-violet-500"
              >
